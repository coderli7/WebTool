...
import com.lxl.webtool.dao.mapper.AuthoritiesMapper;
...
import com.lxl.webtool.dao.pojo.UsersExample;
import com.lxl.webtool.dao.pojo.UsersExample.Criteria;
...
public class UsersServiceImpl implements UsersService {
	...
	public void delete(String[] userNames) {
		for (String userName : userNames) {
			...
			com.lxl.webtool.dao.pojo.AuthoritiesExample.Criteria criteria = authoritiesExample
					.createCriteria();
